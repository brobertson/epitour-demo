...
public class MainActivity extends FragmentActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.menu_item_clear_geofence1) {
			...
			return true;
		} else if (itemId == R.id.menu_item_clear_geofence2) {
			...
			return true;
		} else if (itemId == R.id.menu_item_clear_geofences) {
			mLatitude1.setText(GeofenceUtils.EMPTY_STRING);
			mLongitude1.setText(GeofenceUtils.EMPTY_STRING);
			mRadius1.setText(GeofenceUtils.EMPTY_STRING);
			mLatitude2.setText(GeofenceUtils.EMPTY_STRING);
			...
			mRadius2.setText(GeofenceUtils.EMPTY_STRING);
			return true;
		} else if (itemId == R.id.menu_item_clear_geofence_history) {
    ...
    protected void onPause() {
        super.onPause();
        /* 
         * Before setting, check that this isn't the first time we've used the application
         * and have not set these values, because in that case, we get a nullPointerException
         * onPause()
         */
        if  (!(mUIGeofence1 == null)) {
